<?php /* Enleve les droit d'admin à un utilisateur*/ 
    include '../header.php'; 
    include '../mysql.php';
    // On vérifie que l'utilisateur existe est on ajoute des droits
    ...
    if(isset($exist)) {// On vérifie que l'utilisateur existe
        $req = $connect->prepare('UPDATE user SET admin=1 WHERE pseudo=:pseudo');
        $req->execute(array('pseudo' => $_POST['pseudo']));
        $req->closeCursor();
        header('Location: ../../admin.php?sec=add_admin&msg=addadmin');    
