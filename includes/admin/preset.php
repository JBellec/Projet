...
<div class="col-md-6">
<h2 class="sub-header">Delete preset</h2>
    <form role="form" method="post" action="includes/admin/act_del_preset.php">
        <div class="form-group">
            <label for="presetId">Preset Name</label>
            <input type="text" class="form-control" name="name" placeholder="Enter the preset's name to delete">
        </div>
