               ...
               include ('mysql.php');        
                ...
                try
                {
                        ...
                        // Résultat du comptage = 0 pour ce pseudo, on peut donc l'enregistrer
                        {
                                ...
                                $modification = "UPDATE user(pseudo,password, email, nom, prenom) VALUES(:pseudo, :password, :email, :nom, :prenom)";
                               
                                // préparation de l'insertion
                                $modif_prep = $connect->prepare($modification);
                               
                                // Exécution de la requête en passant les marqueurs et leur variables associées dans un tableau
                                $modif_exec = $modif_prep->execute(array(':pseudo'=>$pseudo,':password'=>$pass_hache = sha1($pass), ':email'=>$email, ':nom'=>$nom,':prenom'=>$prenom,));
